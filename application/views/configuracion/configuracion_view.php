            ...
            <div class="row">
                <div class="p-5 col-lg-6 col-10 mx-auto border">
                    ...
                    <form action="config/set_sujeto" method="post">
                        ...
                        <div class="form-group">
                            <small class="form-text text-muted text-right">Sujeto actual registrado: <?php if(isset($_SESSION['sujeto'])){echo $_SESSION['sujeto'];}?></small>
                        </div>
                    ...
                    <button class="btn btn-alert" onclick="window.location.href ='http://localhost/flanker_task/config_seg_etapa'">Config. 2da Etapa</button>
